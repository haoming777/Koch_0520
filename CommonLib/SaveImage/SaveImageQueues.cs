...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile> _que;
        ...
        private static SaveImageQueues _instance = new SaveImageQueues();

        private SaveImageQueues()
        {
            _que = new ConcurrentQueue<ImageFile>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile image)
        {
