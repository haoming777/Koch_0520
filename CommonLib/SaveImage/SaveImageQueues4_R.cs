...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues4_R
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile4_R> _que;
        ...
        private static SaveImageQueues4_R _instance = new SaveImageQueues4_R();

        private SaveImageQueues4_R()
        {
            _que = new ConcurrentQueue<ImageFile4_R>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues4_R Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile4_R image)
        {
