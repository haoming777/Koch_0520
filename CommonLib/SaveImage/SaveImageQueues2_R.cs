...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues2_R
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile2_R> _que;
        ...
        private static SaveImageQueues2_R _instance = new SaveImageQueues2_R();

        private SaveImageQueues2_R()
        {
            _que = new ConcurrentQueue<ImageFile2_R>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues2_R Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile2_R image)
        {
