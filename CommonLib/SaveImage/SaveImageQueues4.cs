...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues4
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile4> _que;
        ...
        private static SaveImageQueues4 _instance = new SaveImageQueues4();

        private SaveImageQueues4()
        {
            _que = new ConcurrentQueue<ImageFile4>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues4 Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile4 image)
        {
