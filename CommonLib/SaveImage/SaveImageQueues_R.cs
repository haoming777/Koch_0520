...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues_R
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile_R> _que;
        ...
        private static SaveImageQueues_R _instance = new SaveImageQueues_R();

        private SaveImageQueues_R()
        {
            _que = new ConcurrentQueue<ImageFile_R>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues_R Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile_R image)
        {
