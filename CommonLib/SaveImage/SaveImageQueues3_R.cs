...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues3_R
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile3_R> _que;
        ...
        private static SaveImageQueues3_R _instance = new SaveImageQueues3_R();

        private SaveImageQueues3_R()
        {
            _que = new ConcurrentQueue<ImageFile3_R>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues3_R Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile3_R image)
        {
