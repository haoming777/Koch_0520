...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues3
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile3> _que;
        ...
        private static SaveImageQueues3 _instance = new SaveImageQueues3();

        private SaveImageQueues3()
        {
            _que = new ConcurrentQueue<ImageFile3>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues3 Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile3 image)
        {
