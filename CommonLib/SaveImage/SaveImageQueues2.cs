...
namespace CommonLib
{
    ...
    public sealed class SaveImageQueues2
    {
        //private static readonly IEasyLogger logger = EasyLogger.GetInstance("logs");
        /// <summary>
        /// 记录消息Queue
        /// </summary>
        private readonly ConcurrentQueue<ImageFile2> _que;
        ...
        private static SaveImageQueues2 _instance = new SaveImageQueues2();

        private SaveImageQueues2()
        {
            _que = new ConcurrentQueue<ImageFile2>();
            _mre = new ManualResetEvent(false);
        }
        public static SaveImageQueues2 Instance()
        {
            return _instance;
        }
        ...
        public static void PushImage(ImageFile2 image)
        {
